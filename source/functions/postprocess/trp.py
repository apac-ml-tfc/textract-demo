"""Textract Results Parser

Copied from https://github.com/aws-samples/amazon-textract-code-samples/blob/master/python/trp.py
Might be nice to install via PyPI instead: https://pypi.org/project/textract-trp/
