"""
expiringdict - copyright mailgun, Included under Apache License 2.0 per:
https://github.com/mailgun/expiringdict/blob/master/LICENSE

Copied here to get around lack of containerized SAM build with Amplify

TODO: Factor out to use the PyPI library instead
